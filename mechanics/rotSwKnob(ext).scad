...
05_shaft_diameter = 3.4; // this could be a slider if precision were available
...
09_shaft_hole_flat_size = 2.8; // this could be a slider if precision were available
