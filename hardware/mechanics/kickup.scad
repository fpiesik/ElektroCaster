...
//translate([bX/2-screwMdia*1,-bY/2+screwMdia*2.5,0])cylinder(d=screwMdia-t,h=tZ);
//translate([-bX/2+screwMdia*1.5,bY/2-screwMdia*1.5,0])cylinder(d=screwMdia,h=tZ);
//translate([bX/2-screwMdia*1.5,-bY/2+screwMdia*1.5,0])cylinder(d=screwMdia,h=tZ);



translate([-bodySlotX/2+slotXY/2,0,0])cylinder(d=screwMdia-t,h=tZ);
translate([bodySlotX/2-slotXY/2,0,0])cylinder(d=screwMdia-t,h=tZ);}
}
...
//translate([0,0,bZ])rotate([0,0,0])topMacMag();
